...
printf("[Sender] sending: myPort!mDouble\n");
fifo_lock();
...
printf("[Sender] sending: myPort!mBoolean\n");
fifo_lock();
...
printf("[Sender] sending: myPort!mUInt16\n");
fifo_lock();
...
printf("[Sender] sending: myPort!mLong\n");
fifo_lock();
...
printf("[Sender] sending: myPort!mEnum\n");
fifo_lock();
if ( fifo_byte_available() > 5 ) {
...
printf("[Sender] sending: myPort!mInteger\n");
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
printf("[Sender] sending: myPort!mEmpty\n");
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
printf("[Sender] sending: myPort!mUInt8\n");
fifo_lock();
if ( fifo_byte_available() > 5 ) {
...
printf("[Sender] sending: myPort!mChar\n");
fifo_lock();
if ( fifo_byte_available() > 5 ) {
...
printf("[Sender] sending: myPort!mInt16\n");
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
printf("[Sender] sending: myPort!mFloat\n");
fifo_lock();
if ( fifo_byte_available() > 8 ) {
...
printf("[Sender] sending: myPort!mUInt32\n");
fifo_lock();
if ( fifo_byte_available() > 8 ) {
...
printf("[Sender] sending: myPort!mDoubleFloat\n");
fifo_lock();
if ( fifo_byte_available() > 12 ) {
...
Serialization_test_Cfg_r_myPort_msgs[0] = 8;
Serialization_test_Cfg_r_myPort_handlers_tab[0] = (void*) &Receiver_handle_myPort_mEmpty;
Serialization_test_Cfg_r_myPort_msgs[1] = 10;
...
Serialization_test_Cfg_r_myPort_msgs[3] = 9;
Serialization_test_Cfg_r_myPort_handlers_tab[3] = (void*) &Receiver_handle_myPort_mUInt8;
Serialization_test_Cfg_r_myPort_msgs[4] = 4;
Serialization_test_Cfg_r_myPort_handlers_tab[4] = (void*) &Receiver_handle_myPort_mUInt16;
Serialization_test_Cfg_r_myPort_msgs[5] = 11;
Serialization_test_Cfg_r_myPort_handlers_tab[5] = (void*) &Receiver_handle_myPort_mInt16;
Serialization_test_Cfg_r_myPort_msgs[6] = 13;
Serialization_test_Cfg_r_myPort_handlers_tab[6] = (void*) &Receiver_handle_myPort_mUInt32;
Serialization_test_Cfg_r_myPort_msgs[7] = 7;
Serialization_test_Cfg_r_myPort_handlers_tab[7] = (void*) &Receiver_handle_myPort_mInteger;
Serialization_test_Cfg_r_myPort_msgs[8] = 5;
Serialization_test_Cfg_r_myPort_handlers_tab[8] = (void*) &Receiver_handle_myPort_mLong;
Serialization_test_Cfg_r_myPort_msgs[9] = 2;
Serialization_test_Cfg_r_myPort_handlers_tab[9] = (void*) &Receiver_handle_myPort_mDouble;
Serialization_test_Cfg_r_myPort_msgs[10] = 12;
Serialization_test_Cfg_r_myPort_handlers_tab[10] = (void*) &Receiver_handle_myPort_mFloat;
Serialization_test_Cfg_r_myPort_msgs[11] = 6;
Serialization_test_Cfg_r_myPort_handlers_tab[11] = (void*) &Receiver_handle_myPort_mEnum;
Serialization_test_Cfg_r_myPort_msgs[12] = 14;
Serialization_test_Cfg_r_myPort_handlers_tab[12] = (void*) &Receiver_handle_myPort_mDoubleFloat;
...
Serialization_test_Cfg_s_var.Sender_myI__var = 13;
