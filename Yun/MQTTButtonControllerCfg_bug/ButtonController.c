...
void ButtonController_send_WS_LEDisON(struct ButtonController_Instance *_instance);
void ButtonController_send_WS_LEDisOFF(struct ButtonController_Instance *_instance);
...
ButtonController_send_WS_LEDisOFF(_instance);
printf("[CPU] LEDOFF\n");
...
ButtonController_send_WS_LEDisON(_instance);
printf("[CPU] LEDON\n");
ButtonController_LEDControllerChart_State_event_consumed = 1;
}
}
...
void (*external_ButtonController_send_WS_LEDisON_listener)(struct ButtonController_Instance *)= 0x0;
...
void (*ButtonController_send_WS_LEDisON_listener)(struct ButtonController_Instance *)= 0x0;
...
void ButtonController_send_WS_LEDisON(struct ButtonController_Instance *_instance){
if (ButtonController_send_WS_LEDisON_listener != 0x0) ButtonController_send_WS_LEDisON_listener(_instance);
if (external_ButtonController_send_WS_LEDisON_listener != 0x0) external_ButtonController_send_WS_LEDisON_listener(_instance);
;
}
void (*external_ButtonController_send_WS_LEDisOFF_listener)(struct ButtonController_Instance *)= 0x0;
...
void (*ButtonController_send_WS_LEDisOFF_listener)(struct ButtonController_Instance *)= 0x0;
...
void ButtonController_send_WS_LEDisOFF(struct ButtonController_Instance *_instance){
if (ButtonController_send_WS_LEDisOFF_listener != 0x0) ButtonController_send_WS_LEDisOFF_listener(_instance);
if (external_ButtonController_send_WS_LEDisOFF_listener != 0x0) external_ButtonController_send_WS_LEDisOFF_listener(_instance);
;
}
