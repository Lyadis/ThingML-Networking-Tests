...
void ButtonController_send_mqttport_LEDisON(struct ButtonController_Instance *_instance, uint16_t TopicID);
void ButtonController_send_mqttport_LEDisOFF(struct ButtonController_Instance *_instance, uint16_t TopicID);
...
void ButtonController_handle_mqttport_LEDOFF(struct ButtonController_Instance *_instance) {
printf("[ButtonController] handling: mqttport?LEDOFF\n");
...
void ButtonController_handle_mqttport_LEDON(struct ButtonController_Instance *_instance) {
printf("[ButtonController] handling: mqttport?LEDON\n");
uint8_t ButtonController_LEDControllerChart_State_event_consumed = 0;
if (_instance->ButtonController_LEDControllerChart_State == BUTTONCONTROLLER_LEDCONTROLLERCHART_RUNNING_STATE) {
if (ButtonController_LEDControllerChart_State_event_consumed == 0 && 1) {
...
if (ButtonController_LEDControllerChart_State_event_consumed == 0 && 1) {
ButtonController_send_LEDport_LEDOFF(_instance);
ButtonController_send_mqttport_LEDisOFF(_instance,  -1);
printf("[CPU] LEDOFF\n");
ButtonController_LEDControllerChart_State_event_consumed = 1;
}
}
...
if (ButtonController_LEDControllerChart_State_event_consumed == 0 && 1) {
ButtonController_send_LEDport_LEDON(_instance);
ButtonController_send_mqttport_LEDisON(_instance, 0);
printf("[CPU] LEDON\n");
ButtonController_LEDControllerChart_State_event_consumed = 1;
}
}
...
void (*external_ButtonController_send_mqttport_LEDisON_listener)(struct ButtonController_Instance *, uint16_t)= 0x0;
void register_external_ButtonController_send_mqttport_LEDisON_listener(void (*_listener)(struct ButtonController_Instance *, uint16_t)){
external_ButtonController_send_mqttport_LEDisON_listener = _listener;
}
void (*ButtonController_send_mqttport_LEDisON_listener)(struct ButtonController_Instance *, uint16_t)= 0x0;
void register_ButtonController_send_mqttport_LEDisON_listener(void (*_listener)(struct ButtonController_Instance *, uint16_t)){
ButtonController_send_mqttport_LEDisON_listener = _listener;
}
void ButtonController_send_mqttport_LEDisON(struct ButtonController_Instance *_instance, uint16_t TopicID){
if (ButtonController_send_mqttport_LEDisON_listener != 0x0) ButtonController_send_mqttport_LEDisON_listener(_instance, TopicID);
if (external_ButtonController_send_mqttport_LEDisON_listener != 0x0) external_ButtonController_send_mqttport_LEDisON_listener(_instance, TopicID);
;
}
void (*external_ButtonController_send_mqttport_LEDisOFF_listener)(struct ButtonController_Instance *, uint16_t)= 0x0;
void register_external_ButtonController_send_mqttport_LEDisOFF_listener(void (*_listener)(struct ButtonController_Instance *, uint16_t)){
external_ButtonController_send_mqttport_LEDisOFF_listener = _listener;
}
void (*ButtonController_send_mqttport_LEDisOFF_listener)(struct ButtonController_Instance *, uint16_t)= 0x0;
void register_ButtonController_send_mqttport_LEDisOFF_listener(void (*_listener)(struct ButtonController_Instance *, uint16_t)){
ButtonController_send_mqttport_LEDisOFF_listener = _listener;
}
void ButtonController_send_mqttport_LEDisOFF(struct ButtonController_Instance *_instance, uint16_t TopicID){
if (ButtonController_send_mqttport_LEDisOFF_listener != 0x0) ButtonController_send_mqttport_LEDisOFF_listener(_instance, TopicID);
if (external_ButtonController_send_mqttport_LEDisOFF_listener != 0x0) external_ButtonController_send_mqttport_LEDisOFF_listener(_instance, TopicID);
;
}
