...
externalMessageEnqueue(forward_buf, 4, Websocket_instance.listener_id);
...
if(clientID < 16) {
if(Websocket_clients[clientID] != NULL) {
m = libwebsocket_write(Websocket_clients[clientID], p, (length * 3 + 1), LWS_WRITE_TEXT);
} else {
