...
// BEGIN: Code from the c_global annotation ButtonController
SoftwareSerial mySerial(10, 11);
// END: Code from the c_global annotation ButtonController
...
mySerial.println("[Controller] sent LEDOFF");

}
if( !((_instance->ButtonController_LEDON__var))) {
ButtonController_send_LEDport_LEDON(_instance);
mySerial.println("[Controller] sent LEDON");
...
forwardMessageSerial(forward_buf, 4);
}
