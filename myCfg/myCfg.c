...
struct Msg_Handler * myCfg_receivers[NB_MAX_CONNEXION];

//Declaration of instance variables
//Instance myCfg_t2
struct T2_Instance myCfg_t2_var;
struct Msg_Handler myCfg_t2_p1_handlers;
uint16_t myCfg_t2_p1_msgs[2];
void * myCfg_t2_p1_handlers_tab[2];

struct Msg_Handler myCfg_t2_p2_handlers;
uint16_t myCfg_t2_p2_msgs[2];
void * myCfg_t2_p2_handlers_tab[2];
...
executor_dispatch_m2(myCfg_t1_var.p1_receiver_list_head,myCfg_t1_var.p1_receiver_list_tail);}
if (sender == myCfg_t1_var.id_p2) {
executor_dispatch_m2(myCfg_t1_var.p2_receiver_list_head,myCfg_t1_var.p2_receiver_list_tail);}
}
...
if (sender == myCfg_t1_var.id_p1) {
executor_dispatch_m(myCfg_t1_var.p1_receiver_list_head,myCfg_t1_var.p1_receiver_list_tail);}
if (sender == myCfg_t1_var.id_p2) {
executor_dispatch_m(myCfg_t1_var.p2_receiver_list_head,myCfg_t1_var.p2_receiver_list_tail);}
}
...
myCfg_receivers[0] = &myCfg_t2_p1_handlers;
myCfg_receivers[1] = &myCfg_t2_p2_handlers;
myCfg_t1_var.p1_receiver_list_head = &myCfg_receivers[0];
myCfg_t1_var.p1_receiver_list_tail = &myCfg_receivers[1];
myCfg_t1_var.id_p2 = add_instance( (void*) &myCfg_t1_var);
myCfg_receivers[2] = &myCfg_t2_p2_handlers;
myCfg_t1_var.p2_receiver_list_head = &myCfg_receivers[2];
myCfg_t1_var.p2_receiver_list_tail = &myCfg_receivers[2];
...
myCfg_t2_p1_msgs[0] = 2;
myCfg_t2_p1_handlers_tab[0] = &T2_handle_p1_m;
myCfg_t2_p1_msgs[1] = 1;
myCfg_t2_p1_handlers_tab[1] = &T2_handle_p1_m2;
myCfg_t2_p1_handlers.nb_msg = 2;
myCfg_t2_p1_handlers.msg = &myCfg_t2_p1_msgs;
myCfg_t2_p1_handlers.msg_handler = &myCfg_t2_p1_handlers_tab;
myCfg_t2_p1_handlers.instance = &myCfg_t2_var;
myCfg_t2_var.p1_handlers = &myCfg_t2_p1_handlers;
myCfg_t2_var.id_p2 = add_instance( (void*) &myCfg_t2_var);
myCfg_t2_p2_msgs[0] = 2;
myCfg_t2_p2_handlers_tab[0] = &T2_handle_p2_m;
myCfg_t2_p2_msgs[1] = 1;
myCfg_t2_p2_handlers_tab[1] = &T2_handle_p2_m2;
myCfg_t2_p2_handlers.nb_msg = 2;
myCfg_t2_p2_handlers.msg = &myCfg_t2_p2_msgs;
myCfg_t2_p2_handlers.msg_handler = &myCfg_t2_p2_handlers_tab;
myCfg_t2_p2_handlers.instance = &myCfg_t2_var;
myCfg_t2_var.p2_handlers = &myCfg_t2_p2_handlers;
